...
execute_process(COMMAND conan install . -b=missing -pr:a=${Profile} WORKING_DIRECTORY ${CMAKE_SOURCE_DIR} COMMAND_ERROR_IS_FATAL ANY)
execute_process(COMMAND conan install . -s "&:build_type=Debug" -pr:a=${Profile} WORKING_DIRECTORY ${CMAKE_SOURCE_DIR} COMMAND_ERROR_IS_FATAL ANY)
